          ...
          <div className="w-full">
            <div className="mb-4 text-gray-300">
              ...
              <input
                ...
                required
                className="w-full bg-white/3 rounded-xl border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none transition-all"
              />
            </div>
            ...
            <div className="mb-4 text-gray-300">
              ...
              >
                Product Description{" "}
                <span className="text-xs text-violet-400">(oprional)</span>
              </label>
              <textarea
                name=""
            ...
            <div className="mb-4 text-gray-300">
              ...
              <div className="flex gap-3">
                <RectangleVerticalIcon
                  ...
                  className={`p-2.5 size-13 bg-white/6 transition-all ring-2 ring-transparent cursor-pointer ${aspectRatio === "9:16" ? "ring-violet-500/50 bg-white/10" : ""}`}
                />

                <RectangleHorizontalIcon
                  onClick={() => setAspectRatio("16:9")}
                  className={`p-2.5 size-13 bg-white/6 transition-all ring-2 ring-transparent cursor-pointer ${aspectRatio === "16:9" ? "ring-violet-500/50 bg-white/10" : ""}`}
                />
              </div>
            </div>
